---
date: 2019-9-11 19:19:19
layout: post
title: MySQL常用语法
subtitle: 最流行的数据库 
description: 开源的数据库
image: >-
  http://tva1.sinaimg.cn/large/007X8olVly1g82hkxxk1oj30l40b3di0.jpg
optimized_image: >-
  http://tva1.sinaimg.cn/large/007X8olVly1g82hky49v8j30ak05kwez.jpg
category: 数据库
tags:
  - MySQL
  - 数据库
...
1、创建数据库：**cerate database 数据库名 charset=utf8;**<br/>
...
5、查看当前所有的数据库：**show databases;**

6、查看数据库基本信息：**show create database 数据库名**

7、修改数据库编码：**alter database 数据库名 character set 编码格式(utf8)**
...
6、更改表名称：**rename table 原表名 to 新表名;**

7、查看表的创建语：**show create table 表名;**
